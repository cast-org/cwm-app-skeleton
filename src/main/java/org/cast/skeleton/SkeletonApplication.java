...
import org.cast.skeleton.page.HomePage;
import org.cast.skeleton.page.LoginPage;
import org.cast.skeleton.service.SkeletonEventService;
import org.cast.skeleton.service.SkeletonUserContentService;
 ...
 */
public class SkeletonApplication extends CwmApplication {
...
//				binder.bind(IUserPreferenceService.class).to(UserPreferenceService.class);
				binder.bind(IEventService.class).to(SkeletonEventService.class);
				binder.bind(IUserContentService.class).to(SkeletonUserContentService.class);
			}});
		return modules;
	}
